function [outputStruct]=fewarpStructTemplate_LabComp(varargin)
...
%% Constraints section
%-> Define FEwarp plugin constraints
febio_spec.Constraints.constraint.ATTR.type='warp-image';
febio_spec.Constraints.constraint.template.ATTR.file='C:\Users\shochmut\OneDrive for Business\Documents\CSU_19\Ghosh Research\MRI_Image_Analysis\finalnosegment_14_Supine_L2L3.tif_20.raw';
febio_spec.Constraints.constraint.template.size=[50,50,20];
febio_spec.Constraints.constraint.target.ATTR.file='C:\Users\shochmut\OneDrive for Business\Documents\CSU_19\Ghosh Research\MRI_Image_Analysis\finalnosegment_14_Standing_L2L3.tif_20.raw';
febio_spec.Constraints.constraint.target.size=[50,50,20];
febio_spec.Constraints.constraint.range_min=[0,0,0];
febio_spec.Constraints.constraint.range_max=[50,50,20];
febio_spec.Constraints.constraint.penalty.ATTR.lc=1;
febio_spec.Constraints.constraint.penalty.VAL=1;
febio_spec.Constraints.constraint.blur.ATTR.lc=2;
febio_spec.Constraints.constraint.blur.VAL=1;
febio_spec.Constraints.constraint.laugon=1;
febio_spec.Constraints.constraint.altol=0.1;

%% LoadData section

febio_spec.LoadData.loadcurve{1}.ATTR.id=1;
febio_spec.LoadData.loadcurve{1}.ATTR.type='linear';
febio_spec.LoadData.loadcurve{1}.point.VAL=[0 0;0.5 10;1.0 50];
febio_spec.LoadData.loadcurve{2}.ATTR.id=2;
febio_spec.LoadData.loadcurve{2}.ATTR.type='linear';
febio_spec.LoadData.loadcurve{2}.point.VAL=[0 10;1 0];
...
febio_spec.Output.plotfile.var{3}.ATTR.type='warp-template';
febio_spec.Output.plotfile.var{4}.ATTR.type='warp-target';
febio_spec.Output.plotfile.var{5}.ATTR.type='warp-energy';
febio_spec.Output.plotfile.var{5}.ATTR.type='warp-force';
